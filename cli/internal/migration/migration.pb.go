...
type OtpParameters struct {
	...
	Algorithm     Algorithm              `protobuf:"varint,4,opt,name=algorithm,proto3,enum=migration.Algorithm" json:"algorithm,omitempty"`
	Digits        DigitCount             `protobuf:"varint,5,opt,name=digits,proto3,enum=migration.DigitCount" json:"digits,omitempty"`
	Type          OtpType                `protobuf:"varint,6,opt,name=type,proto3,enum=migration.OtpType" json:"type,omitempty"`
...
const file_migration_proto_rawDesc = "" +
	"\n" +
	"\x0fmigration.proto\x12\tmigration\"\xc8\x01\n" +
	"\x10MigrationPayload\x12?\n" +
	"\x0eotp_parameters\x18\x01 \x03(\v2\x18.migration.OtpParametersR\rotpParameters\x12\x18\n" +
	...
	"\talgorithm\x18\x04 \x01(\x0e2\x14.migration.AlgorithmR\talgorithm\x12-\n" +
	"\x06digits\x18\x05 \x01(\x0e2\x15.migration.DigitCountR\x06digits\x12&\n" +
	"\x04type\x18\x06 \x01(\x0e2\x12.migration.OtpTypeR\x04type\x12\x18\n" +
	...
	"\rOTP_TYPE_TOTP\x10\x02B.Z,github.com/kimmojae/qr2fa/internal/migrationb\x06proto3"
...
var file_migration_proto_goTypes = []any{
	(Algorithm)(0),           // 0: migration.Algorithm
	(DigitCount)(0),          // 1: migration.DigitCount
	(OtpType)(0),             // 2: migration.OtpType
	(*MigrationPayload)(nil), // 3: migration.MigrationPayload
	(*OtpParameters)(nil),    // 4: migration.OtpParameters
}
var file_migration_proto_depIdxs = []int32{
	4, // 0: migration.MigrationPayload.otp_parameters:type_name -> migration.OtpParameters
	0, // 1: migration.OtpParameters.algorithm:type_name -> migration.Algorithm
	1, // 2: migration.OtpParameters.digits:type_name -> migration.DigitCount
	2, // 3: migration.OtpParameters.type:type_name -> migration.OtpType
